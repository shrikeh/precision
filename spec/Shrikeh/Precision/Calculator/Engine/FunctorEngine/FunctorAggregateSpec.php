...
class FunctorAggregateSpec extends ObjectBehavior
{
    ...
    {
        $functorFactory->offsetGet(FunctorFactory::DIVIDE)->willReturn(function() { return '3'; });
        $this->divide(15.9, 5.3)->shouldReturn('3');
    }

    function it_can_multiply_floats($functorFactory)
    {
        $functorFactory->offsetGet(FunctorFactory::MULTIPLY)->willReturn(function() { return '9.494'; });
        $this->multiply(4.315842, 2.2, 3)->shouldReturn('9.494');
    }

    function it_can_divide_floats($functorFactory)
    {
        $functorFactory->offsetGet(FunctorFactory::DIVIDE)->willReturn(function() { return '3.6469586'; });
        $this->divide(18.175439201, 4.98372504, 7)->shouldReturn('3.6469586');
    }

    function it_can_add($functorFactory)
    {
        $functorFactory->offsetGet(FunctorFactory::ADD)->willReturn(function() { return '7.998'; });
        $this->add(4.998549, 3, 3)->shouldReturn('7.998');
    }

    function it_can_subtract($functorFactory)
    {
        $functorFactory->offsetGet(FunctorFactory::SUBTRACT)->willReturn(function() { return '5.646454667'; });
    ...
    {
        $functorFactory->offsetGet(FunctorFactory::POW)->willReturn(function() { return '8865734531.0674715'; });
        $this->pow(12.7438789, 9, 7)->shouldReturn('8865734531.0674715');
    }

    function it_returns_a_valid_modulus($functorFactory)
    {
        $functorFactory->offsetGet(FunctorFactory::MOD)->willReturn(function() { return '0.64597'; });
